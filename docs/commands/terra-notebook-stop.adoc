...
terra-notebook-stop - Stop a running GCP Notebook instance within your workspace.
...
*terra notebook stop* [*--location*=_<location>_] [*--workspace*=_<id>_]
