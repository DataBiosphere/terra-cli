...
public class DockerAppsRunner {
  ...
  private final DockerContainerUtils dockerContainer;
  ...
  public DockerAppsRunner(GlobalContext globalContext, WorkspaceContext workspaceContext) {
    ...
    this.dockerContainer = new DockerContainerUtils();
  }
  ...
  public boolean updateImageId(String imageId) {
    boolean imageExists = dockerContainer.checkImageExists(imageId);
    if (imageExists) {
  ...
  public void runToolCommand(String command, Map<String, String> envVars) {
    ...
    dockerContainer.outputLogsForDockerContainer(containerId);

    // block until the container exits
    Integer statusCode = dockerContainer.waitForDockerContainerToExit(containerId);
    logger.debug("docker run status code: {}", statusCode);

    // delete the container
    dockerContainer.deleteDockerContainer(containerId);
  }
  ...
  private String startDockerContainerWithTerraInit(
    ...
    return dockerContainer.startDockerContainer(
