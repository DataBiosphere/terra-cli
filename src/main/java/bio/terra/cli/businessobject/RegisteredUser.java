...
/**
 * Internal representation of a registered user (i.e. someone who could register as a user in
 * Terra). This is different from a regular {@link User} because they are never logged in. This is
 * just a reference to another Terra user who has a record in SAM. This class is not part of the
 * current context or state.
 */
public class RegisteredUser {
  private static final Logger logger = LoggerFactory.getLogger(RegisteredUser.class);
  ...
  private RegisteredUser(String email, String subjectId, boolean isRegistered, boolean isEnabled) {
    this.email = email;
  ...
  public static RegisteredUser getUser(String email) {
    ...
    return new RegisteredUser(
        emailFromSAM, subjectIdFromSAM, isRegisteredFromSAM, isEnabledFromSAM);
  }
